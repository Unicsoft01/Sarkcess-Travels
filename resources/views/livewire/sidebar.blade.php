<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarFrontend" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarFrontend">
                    <span class="nav-icon">
            ...
            <livewire:livewire.navlink page="Media Handles" route='admin.social-media'
                icon="solar:chat-square-like-bold-duotone" />

            <livewire:livewire.navlink page="Blog Posts" route='admin.blog-posts'
                icon="solar:book-bookmark-bold-duotone" />

            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarCountries" data-bs-toggle="collapse" role="button"
                ...
                <div class="collapse" id="sidebarCountries">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('admin.countries') }}" wire:navigate>List of Countries</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('admin.countries.create') }}">Add new Countries</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarUniversities" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarUniversities">
                    <span class="nav-icon">
                        <iconify-icon icon="solar:book-bookmark-bold-duotone"></iconify-icon>
                    </span>
                    <span class="nav-text"> Universities </span>
                </a>
                <div class="collapse" id="sidebarUniversities">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('admin.universities') }}" wire:navigate>List of Universities</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('admin.universities.create') }}"  wire:navigate>Add new universities</a>
                        </li>
                    </ul>
                </div>
            </li>

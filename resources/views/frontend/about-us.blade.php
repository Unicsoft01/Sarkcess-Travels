<div>
    ...
    ** About **
    =================================================== -->
    <livewire:frontend.inc.intro-sec />
    ...
    ** About Video **
    ...
    <section class="about-video">
        <div class="container">
            <p>Take a tour <a class="video" href="https://www.youtube.com/watch?v=i11RXCJVEnw"> <span
                        class="icon-play-icon"></span></a> Know more</p>
        </div>
    </section>
    ...
    <section class="our-impotance padding-lg">
        <div class="container">
            <ul class="row">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="images/practical-ico.jpg"
        ...
        <div class="container">
            ...
            <ul class="row browse-teachers-list clearfix">
                <li class="col-xs-6 col-sm-3">
                    ...
                    <p class="equal-hight">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        ...
        <div class="container">
            <div class="wrapper">
                ...
                <div id="bx-pager"> <a data-slide-index="0" href="#"><img src="images/testimonial-thumb1.jpg"
                            ...
                            src="images/testimonial-thumb2.jpg" class="img-circle" alt="" /></a> <a
                        data-slide-index="2" href="#"><img src="images/testimonial-thumb3.jpg"
                            class="img-circle" alt="" /></a> </div>
            </div>
        </div>
    </section>
</div>

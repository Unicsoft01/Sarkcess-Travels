        ...
        <div class="container">
            <ul class="row our-links">
                ...
                <li class="col-sm-3 prospects clearfix equal-hight">
                    <div class="icon"><img src="{{ url('/') }}/frontend/images/prospects-ico.png"
    ...
    {{-- <section class="our-cources padding-lg">
        <div class="container">
            ...
            <ul class="course-list owl-carousel">
                <li>
                    <div class="inner">
                        <figure><img src="{{ url('/') }}/frontend/images/course-img1.jpg" alt="">
                        </figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{ url('/') }}/frontend/images/course-img2.jpg" alt="">
                        </figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{ url('/') }}/frontend/images/course-img3.jpg" alt="">
                        </figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{ url('/') }}/frontend/images/course-img4.jpg" alt="">
                        </figure>
        ...
        <div class="container">
            <ul class="row">
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ url('/') }}/frontend/images/study-time-ico.jpg"
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ url('/') }}/frontend/images/placement-ico.jpg"
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ url('/') }}/frontend/images/easy-access-ico.jpg"
                            alt="Easy To Access">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ url('/') }}/frontend/images/study-go-ico.jpg"
                            alt="Study on the Go">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ url('/') }}/frontend/images/get-innovative-ico.jpg"
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ url('/') }}/frontend/images/practical-ico.jpg"
    ...
    <section class="news-events padding-lg">
        <div class="container">
            ...
            <ul class="row cs-style-3">
                <li class="col-sm-4">
                    <div class="inner">
                        <figure> <img src="{{ url('/') }}/frontend/images/new-event-img1.jpg"
    ...
    <section class="logos">
        <div class="container">
            <ul class="owl-carousel clearfix">
                <li><a href="#"><img src="{{ url('/') }}/frontend/images/logo1.jpg"
                            class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ url('/') }}/frontend/images/logo2.jpg"
                            class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ url('/') }}/frontend/images/logo3.jpg"
                            class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ url('/') }}/frontend/images/logo4.jpg"
                            class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ url('/') }}/frontend/images/logo5.jpg"
                            class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ url('/') }}/frontend/images/logo6.jpg"
                            class="img-responsive" alt=""></a></li>
            </ul>
        </div>
    </section>
            ...
            <div class="wrapper">
                ...
                <div id="bx-pager">
                    <a data-slide-index="0" href="#"><img
                            src="{{ url('/') }}/frontend/images/testimonial-thumb1.jpg" class="img-circle"
                            alt="" /></a>
                    <a data-slide-index="1" href="#"><img
                            src="{{ url('/') }}/frontend/images/testimonial-thumb2.jpg" class="img-circle"
                            alt="" /></a>
                    <a data-slide-index="2" href="#"><img
                            src="{{ url('/') }}/frontend/images/testimonial-thumb3.jpg" class="img-circle"
                            alt="" /></a>
                </div>
            </div>
        </div>

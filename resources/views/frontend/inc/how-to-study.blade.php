    ...
    <div class="container">
        ...
        <ul class="row">
            <li class="col-sm-4">
                ...
                <p class="text-justified">{{ Str::limit($how2apply->description1, $limit = 110, $end = '...') }}</p>
            </li>
            <li class="col-sm-4 active">
                ...
                <p class="text-justified">{{ Str::limit($how2apply->description2, $limit = 110, $end = '...') }}</p>
            </li>
            <li class="col-sm-4 ">
                <div class="icon-block"> <span class="num">3</span> <img
                        src="{{ url('/') }}/frontend/images/get-start-ico.png" alt=""></div>
                <h3>{{ $how2apply->step3 }}</h3>
                <p class="text-justified">{{ Str::limit($how2apply->description3, $limit = 110, $end = '...') }}</p>
            </li>
        </ul>
